...
render(){
  return (
    <div id="contact" className="carousel-item h-screen text-white justify-center items-center px-6 select-none flex-col touch-pan-up overflow-y-hidden snap-end">
      ...
      <div className="form-control p-6 gap-10 w-96" >
        <label className="input-group relative">
            ...
            <input enterKeyHint="next" type="email" required placeholder="Enter email here..." name='email' className="input input-bordered focus:outline-none caret-primary touch-pan-y focus:placeholder:invisible border-primary w-full" id="email"/>
            <button className=" absolute bottom-2 right-3" onClick={() => document.getElementById('email').value = ''}><img src={clear} className='w-7 '/></button>
        </label>
        <label className="input-group relative">
            ...
            <input enterKeyHint="next" type="text" required placeholder="Enter name here..." name='name' className="input input-bordered focus:outline-none caret-primary focus:placeholder:invisible border-primary w-full" id="name"/>
            <button className=" absolute bottom-2 right-3" onClick={() => document.getElementById('name').value = ''}><img src={clear} className='w-7 '/></button>
        </label>
